...
//    }
    ...
    public static void main(String[] args) {
        ...
        fibHeap fibonacciHeap = new fibHeap(fib);
        ...
        for (int i = 0; i < fib.length; i++) {
            ...
            cntDelete.add(fibonacciHeap.getCntDelete());
        ...
        System.out.println("Кол-во итераций добавления:" + cntAdd.size());
        System.out.println("Кол-во итераций поиска: " + cntFind.size());
        System.out.println("Кол-во итераций удаления: " + cntDelete.size());
